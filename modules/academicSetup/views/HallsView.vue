...
<template>
  <BasePageHeading
    title="Lecture Halls"
    subtitle="Classrooms and examination venues"
  >
    <template #extra>
      <button
        v-if="authStore.userCan('halls:write')"
          ...
          <div class="d-flex justify-content-between">
            <div>
              ...
              <div class="text-muted" style="font-size: 12px">
                {{ h.building || "Main Campus" }}
              </div>
              <div class="mt-2 d-flex flex-wrap gap-2">
                <span class="badge bg-secondary"
                  >{{ h.capacity || "—" }} seats</span
                >
                <span
                  class="badge"
                  :class="h.has_camera ? 'bg-success' : 'bg-secondary'"
                >
  ...
  <BaseModal
    ...
    :title="editing ? 'Edit Hall' : 'New Hall'"
  ...
  >
    <div class="row g-3">
      ...
      <div class="col-md-6" v-if="form.has_camera">
        ...
        <input
          v-model.number="form.camera_count"
          type="number"
          class="form-control"
          min="1"
        />
